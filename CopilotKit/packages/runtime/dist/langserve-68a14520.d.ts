...
type RuntimeEvent = {
    ...
    type: RuntimeEventTypes.ContentMessageStart;
    messageId: string;
} | {
...
declare class RuntimeEventSubject extends ReplaySubject<RuntimeEvent> {
    ...
    sendContentMessageStart(messageId: string): void;
    sendContentMessageContent(content: string): void;
    sendContentMessageEnd(): void;
    sendContentMessage(messageId: string, content: string): void;
